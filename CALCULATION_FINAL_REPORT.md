# PER/PBR/Forward PER計算過程 最終報告書

## 報告書情報

- **評価日**: 2025-12-19
- **対象銘柄**: 1605, 6005, 8136, 9202, 8725, 4507, 8111
- **計算ロジック**: 標準的なPER/PBR/Forward PER計算（分割・併合考慮）
- **生成日時**: 2025-12-22
...
```
1. net_shares_fy = shares_outstanding - treasury_shares
2. split_mult = ∏(1 / adjustment_factor)  [FY期末→評価日]
3. net_shares_at_price = net_shares_fy × split_mult
4. eps_std = profit / net_shares_at_price
5. bps_std = equity / net_shares_at_price
6. forecast_eps_std = forecast_profit / net_shares_at_price
7. PER = price / eps_std
8. PBR = price / bps_std
9. Forward PER = price / forecast_eps_std
```
...
**FY実績データ（fins_statements）**:
- 期末日: 2024-12-31
- 開示日: 2025-03-19
- `profit`: 427,344,000,000円
- `equity`: 5,137,833,000,000円
- `shares_outstanding`: 1,259,136,067株
- `treasury_shares`: 61,536,239株
- `eps`（参考）: 345.31円
- `bvps`（参考）: 4,026.22円

**予想データ（fins_statements）**:
- 開示日: 2025-11-13
- 期間種別: 3Q
- `forecast_profit`: 390,000,000,000円
- `forecast_eps`（参考）: 327.97円
...
**ステップ1: FY期末のネット株数**
```
net_shares_fy = 1,259,136,067 - 61,536,239
              = 1,197,599,828株
```
...
**ステップ3: 評価日時点のネット株数**
```
net_shares_at_price = 1,197,599,828 × 1.0
                    = 1,197,599,828株
```

**ステップ4: 標準EPS/BPS**
```
eps_std = 427,344,000,000 / 1,197,599,828 = 356.83円
bps_std = 5,137,833,000,000 / 1,197,599,828 = 4,290.11円
```

**ステップ5: 標準予想EPS**
```
forecast_eps_std = 390,000,000,000 / 1,197,599,828 = 325.65円
```

**ステップ6: PER/PBR/Forward PER**
```
PER = 3,150.00 / 356.83 = 8.83
PBR = 3,150.00 / 4,290.11 = 0.73
Forward PER = 3,150.00 / 325.65 = 9.67
```

#### 検証結果
- ✅ PER: 8.83（システム計算値と一致）
- ✅ PBR: 0.73（システム計算値と一致）
- ✅ Forward PER: 9.67（システム計算値と一致）
...
**FY実績データ**:
- 期末日: 2025-03-31
- `profit`: 23,312,000,000円
- `equity`: 205,719,000,000円
- `shares_outstanding`: 125,291,112株
- `treasury_shares`: 9,601,315株

**予想データ**:
- `forecast_profit`: 26,500,000,000円
...
**FY実績データ**:
- 期末日: 2025-03-31
- `profit`: 41,731,000,000円
- `equity`: 107,608,000,000円
- `shares_outstanding`: 255,408,303株
- `treasury_shares`: 18,121,226株

**予想データ**:
- `forecast_profit`: 49,400,000,000円
...
**FY実績データ**:
- 期末日: 2025-03-31
- `profit`: 153,027,000,000円
- `equity`: 1,140,095,000,000円
- `shares_outstanding`: 484,293,561株
- `treasury_shares`: 14,330,534株

**予想データ**:
- `forecast_profit`: 145,000,000,000円
...
**FY実績データ**:
- 期末日: 2025-03-31
- `profit`: 691,657,000,000円
- `equity`: 4,052,835,000,000円
- `shares_outstanding`: 1,608,398,708株
- `treasury_shares`: 97,131,980株

**予想データ**:
- `forecast_profit`: 590,000,000,000円
...
**FY実績データ**:
- 期末日: 2025-03-31
- `profit`: 170,435,000,000円
- `equity`: 1,362,497,000,000円
- `shares_outstanding`: 889,632,195株
- `treasury_shares`: 38,944,777株

**予想データ**:
- `forecast_profit`: 188,000,000,000円
...
**FY実績データ**:
- 期末日: 2025-03-31
- `profit`: 24,444,000,000円
- `equity`: 111,203,000,000円
- `shares_outstanding`: 47,448,172株
- `treasury_shares`: 3,117,394株

**予想データ**:
- `forecast_profit`: 25,400,000,000円
