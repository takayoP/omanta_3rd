...
**修正後：**
- `as_of_date`パラメータを追加（評価の打ち切り日を明示的に指定）
...
**解決策：**
- 24Mの最適化は、24Mホライズンが完走できるように`end_date`を自動調整
  - `end_date_24m = end_date - 24ヶ月`
  - 例：`end_date=2025-12-31` → `end_date_24m=2023-12-31`
- 12Mはそのまま`end_date`を使用
