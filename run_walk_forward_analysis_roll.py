...
# -*- coding: utf-8 -*-
"""
Walk-Forward Analysis実行スクリプト（roll方式）
長期保有型のWalk-Forward検証をroll方式で実行します
"""
...
def main():
    """Walk-Forward Analysisを実行（roll方式）"""
    print("=" * 80)
    print("Walk-Forward Analysis 実行（roll方式）")
    print("=" * 80)
    print()
    print("設定:")
